...
float quadril::get_ang(float x0, float y0, float x1, float y1, float x2, float y2)
{
...
quadril::quadril(float X1, float X2, float X3, float X4, float Y1, float Y2, float Y3, float Y4)
{
	x1 = X1;
	x2 = X2;
	x3 = X3;
...
bool quadril::in_circle()
{
	return ang1 == ang3 && ang2 == ang4;
}
bool quadril::out_circle()
{
	return a_kord + c_kord == b_kord + d_kord;
}